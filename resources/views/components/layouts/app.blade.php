                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10">
                            <div class="space-y-2 py-6">
                                <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Розклад</a>
                                <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Новини</a>
                            </div>
                            <div class="py-6">
                                    ...
                                    @else
                                        ...
                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}"
                                               class="ml-4 font-semibold text-gray-950">Register</a>
                                        @endif
                                    @endauth
                                    Log in
                                </a>
...
{{--    <div class="flex justify-between w-2/3 mx-auto py-3">--}}
{{--        <a href="/">--}}
{{--            <img src="{{ asset('assets/logo.png') }}" alt="eti" width="100px">--}}
{{--        </a>--}}
